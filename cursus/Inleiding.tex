...
\begin{figure}[h]
  ...
  \caption{Vlakvullingen van Escher.}
  \label{fig:vlakv_escher}
\end{figure}


In Figuur \ref{fig:vlakv_escher} zien we een aantal vlakvullingen van Escher. Hier zullen we later nog op ingaan.\\
...
\teacher{
De verschillende mogelijke reguliere betegelingen staan in Figuur \ref{fig:reguliere_betegelingen}. Steeds is \'{e}\'{e}n regelmatig veelvlak de sjabloon. Deze sjabloon wordt dan over het ganse vlak herhaald na verschuiven of roteren.
\begin{figure}[ht]
  \centering
  \subfloat[Regelmatige driehoeken]{\input{figuren/fig_reguliere_betegeling_met_driehoeken.tex}}
  \subfloat[Vierkanten]{\input{figuren/fig_reguliere_betegeling_met_vierkanten.tex}}
  \subfloat[Regelmatige zeshoeken]{\input{figuren/fig_reguliere_betegeling_met_zeshoeken.tex}}
...
\ask{Hoe komt het dat er door het verplaatsen van de figuren in Figuur \ref{fig:driehoekenparadox} een gat ontstaat?}
