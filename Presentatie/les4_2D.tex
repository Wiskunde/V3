...
\begin{block}{Vraag}
Hebben we ook 100\% efficiëntie als we een oneindig vlak zouden betegelen met cirkels?
\end{block}
\pause
%\begin{figure}[h]
 % \centering
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
  \end{columns}  
%Omdat in het tweede deel van de les en ook de volgende les de leerlingen zelf de efficiëntie zullen moeten berekenen is het goed om dit al eens klassikaal te doen.
%\begin{block}{Vraag}
%Hoe kan je de efficiëntie berekenen aan de hand van zo'n Voronoicel?
%\end{block}
\end{frame}
...
\begin{enumerate}
 ...
 Efficiëntie = $\frac{\pi}{4}=0,78538...$
 \pause
	\item Hexagonale rangschikking:\\
	Efficiëntie = $\frac{\pi}{\sqrt{12}}=0.90689$
	%Dit is ook de meest efficiënte!!! -> Axel Thue heeft dit aangetoond en we geven in de cursus ook een kleine schets van het bewijs.
\end{enumerate}
\end{column}
\begin{column}{0.4\textwidth}     
     \begin{figure}[h]
...
\pause
\begin{block}{Opdracht}Bepaal nu voor een gegeven aantal glazen of blikjes we welk soort dienblad willen maken en wat juist de efficiëntie is%, m.a.w. hoeveel procent van het dienblad dat gevuld zal zijn
...
\begin{enumerate}
	\item Experimenteren a.d.h.v. Geogebra-applets:
					\begin{itemize}
	          \item \href{http://wiskunde.github.com/V3/cirkelvormigdienblad_applet.html}{Cirkelvormig1} en \href{http://wiskunde.github.com/V3/cirkelvormigdienblad2_applet.html}{Cirkelvormig2} 
