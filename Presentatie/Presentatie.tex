...
\begin{figure}[h]
\centering
\only<2>{\includegraphics[height=5cm]{oranges}}
\pause
\only<3>{\includegraphics[height=5cm]{cannonballs}}
\pause
\only<4>{\includegraphics[height=5cm]{dozen}}
\pause
\only<5>{\includegraphics[height=5cm]{dienblad}}
\pause
\only<6>{\includegraphics[height=5cm]{jetons_hex}}
\end{figure}
\end{frame}
...
%\begin{figure}[ht]
 % \centering
  %\subfloat{
   ...
   % \label{fig:driehoekpuzzelen1}
  %}
  %\subfloat{
   % \includegraphics[height=5cm]{PIC0137}
    %\label{fig:kubuspuzzelen1}
  %}
...
%  \centering
 % \subfloat{
  %  \includegraphics[height=5cm]{PIC0134}
   % \label{fig:driehoekpuzzelen2}
  %}
  %\subfloat{
   % \includegraphics[height=5cm]{PIC0136}
    %\label{fig:kubuspuzzelen2}
  %}
  %\caption{Puzzelen van een driehoek en een kubus, oplossing.}
%\end{figure}
