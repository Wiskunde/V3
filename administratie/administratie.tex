...
\begin{itemize}
  \item De leerlingen vullen een vierkant met kleinere vierkanten van de zelfde grootte. Door dit te doen vinden ze een algemene formule die de maximale efficiëntie bepaald.
  \item Het probleem wordt moeilijker gemaakt door te eisen dat het vierkant gevuld moet worden met kleinere vierkanten die allemaal een verschillende grootte moeten hebben (perfect vierkant).
...
We willen samen met leerlingen een theorie rond perfecte vierkanten ontwikkelen.
...
Dan wensen we het probleem moeilijker maken. Hiervoor eisen we dat een vierkant volledig gevuld wordt met kleinere vierkanten die allemaal een verschillende grootte hebben. Omdat dit een moeilijk probleem is, bijvoorbeeld naar het perfect vierkant met de laagste orde is 60 jaar gezocht, geven we zelf een voorbeeld een een beetje geschiedenis.

De leerlingen die toch zelf aan de slag willen gaan, en een perfect vierkant puzzelen, geven we deze kans. Voor hen werden in de appendix de bouwplannen voorzien voor alle perfecte vierkanten van orde 22. Een perfect vierkant vinden is heel moeilijk, maar wanneer je reeds weet wat de groottes zijn van de kleinere vierkantjes wordt het toch haalbaar.
