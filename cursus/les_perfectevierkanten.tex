...
\ask{Verklaar waarom een perfect vierkant van orde $2$ niet kan bestaan. Maak ook een schets:}

\answer[4cm]{Twee vierkanten van verschillende groottes samen vormen niet opnieuw een vierkant.}

\ask{Verklaar waarom ook een perfect vierkant van orde $3$ niet kan bestaan. Maak ook schetsen:}
...
\answer[3cm]{Dit lukt niet. Rond het kleinste vierkant moeten dan nog 3 andere vierkantjes komen want \'e\'en zijde ligt aan de zijkant van het perfecte vierkant. Die drie andere vierkanten zijn allemaal groter dan het kleinste vierkant, dus \'e\'en van die vierkanten zal over de zijkant komen te liggen, waardoor het geen perfect vierkant meer is.}

Hier geef je een bewijs uit het ongerijmde. Je veronderstelt dat je wel iets kan. Bijvoorbeeld het kleinste vierkant op de zijkant van een perfect vierkant leggen. Dan toon je aan dat je tot een tegenstrijdigheid komt. Dus \'e\'en van de vierkantjes die rond het kleinste vierkant ligt zal over de zijde komen te liggen. Het perfecte vierkant is geen perfect vierkant! Hierdoor weet je dat de veronderstelling niet kan. Dus dat het kleinste vierkantje niet op de zijkant kan liggen.

\begin{center}
  \input{figuren/pv_kleinstevierkant.tex}
\end{center}

\subsection{Perfecte kubussen}

In de wiskunde veralgemenen we graag onze resultaten naar alle dimensies. In de les van de perfecte vierkanten hebben we steeds in een vlak gewerkt. Daarbinnen hebben we dan in een vierkant gewerkt. Dit is het tweedimensionale geval. Er bestaat dus een simpeler \'e\'endimensionale geval. Het vlak is dan een rechte. Het vierkant is dan een interval op die recht.

\question{zou ik lijnstuk gebruiken in plaats van interval?}

\task{Geef zelf een definitie voor een perfect interval analoog als voor een perfect vierkant.}

\answer[3cm]{Een interval is een {\bf perfect interval} als het volledig gevuld wordt met kleinere intervallen die allemaal een andere lengte hebben.}

\ask{Toon aan hoe je een perfect interval kunt construeren met de kleinere intervallen van lengte $1$, $2$ en $3$. Waarom zullen we hier weinig nieuwe wiskunde in ontdekken.}

\answer[3cm]{Plaats de drie lijnstukken achter elkaar. Dit geeft dan een nieuw interval dat aan de voorgaande definitie van perfect interval voldoet. Hadden we de drie intervallen in een andere volgorde geplaatst, dan was de constructie van een perfect interval ook gelukt. Het is steeds mogelijk om perfecte intervallen te vinden zonder te puzzelen, voeg gewoon een nieuw interval met nieuwe lengte toe en we hebben een nieuw perfect interval.}
...
\subsection{Meetkundige interpretatie van oplossen van kwadratische vergelijkingen}

\subsection{Meetkundige interpretatie van oplossen van kubische vergelijkingen}
