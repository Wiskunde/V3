...
(Uiteraard is dit pakket dan ook toegankelijk voor leerlingen uit de derde graad, maar misschien is dit voor bepaalde richtingen dan te eenvoudig of niet uitdagend genoeg.)
...
In het eerste deel van de eerste les van \textquoteleft tweedimensionale stapelproblemen' werken de leerlingen samen met de leerkracht aan de hand van een bundeltje die stuk per stuk wordt uitgedeeld. Het is aangewezen dat de leerlingen al in kleine groepjes samen zitten, waarbij de leerkracht echter eerst nog vooraan in de klas de leider is van het onderwijsleergesprek. In het bundeltje staan zoals al de hele lessenreeks vragen en opdrachten. Het is de bedoeling dat de leerkracht de leerlingen aanzet om hierover na te denken of effectief de opdracht uit te voeren. Dit kan gaan van een kleine berekening tot effectief experimenteren met munten. 

Als we bij het dienbladenprobleem zijn aanbeland is het effectief aan de leerlingen om aan de slag te gaan. Ze moeten voor verschillende aantallen munten en verschillende vormen van dienbladen (cirkelvormig, (regelmatige) driehoekig, (regelmatige) zeshoekig, rechthoekig) de efficiëntie berkenen. Het is de bedoeling dat ze dit experimenteel uitvoeren, a.d.h.v. Geogebra-applets en ook aan de hand van echt materiaal (jetons en karton). 
...
Het is echter ook de bedoeling om de leerlingen sommige configuraties ook echt te laten tekenen en de efficiëntie te laten berekenen.
...
In het tweede deel van deze les is het al handig om de leerlingen samen te brengen om wat ze hebben gevonden samen te leggen en samen met de leerlingen de efficiënties van de configuraties met 1, 2 of 3 munten te overlopen. Nu pas worden uiteraard de oplossingen in de cursus uitgedeeld aan de leerlingen.
...
Wiskunde is iets dat leeft. Het is niet zozeer de namen die van belang zijn hier maar het proces. Van het bedenken van nieuwe technieken en begrippen (bijvoorbeeld 
Voronoicellen) tot het reduceren van het probleem. Ook lopen de onderzoekers soms vast op een dood spoor (de verlaging van de bovengrens), dat echter tot andere nieuwe ontdekkingen kan leiden.
