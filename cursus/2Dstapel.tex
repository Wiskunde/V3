...
\todo{Ik weet niet zo goed als ik moet spreken over compactheid of efficiëntie of optimale compactheid of gewoon compactheid of ... !!!!!! Dit is echter wel heel belangrijk om dit correct te benoemen!!
\\PP: ik zou alles terugleiden op 'efficiëntie'}
...
\task{Bepaal nu voor welke hoeveelheid glazen of blikjes we welk soort dienblad willen maken en wat juist de efficiëntie is, m.a.w. hoeveel procent van het dienblad dat gevuld zal zijn. Schrijf dit in onderstaande tabel. \todo{OF} ...juist de (optimale???) compactheid. Deze compactheid is dus hoeveel oppervlakte van het dienblad de munten innemen, uitgedrukt in percentage, en deze wordt berekend door de oppervlakte van de munten te delen door de oppervlakte van het dienblad en dit te vermenigvuldigen met 100.}
...
De oppervlakte van 1 jeton is $4*\pi\approx 12,5663$. Omdat we voornamelijk geïnteresseerd zijn in de optimale compactheid van een dienblad en waarbij hier een resultaat van ... \todo{voorbeeld zoeken van absurd resultaat} geen betekenis heeft, zullen we steeds de afmetingen afronden op 4 cijfers na de komma en de percentage tot op de honderdtallen.


\begin{vb}[Dienbladen met 1 munt]

\begin{figure}[h]
\includegraphics[width=10cm]{1munt}
...
\begin{itemize}
	...
	Wanneer we slechts 1 munt hebben, is een cirkelvormig dienblad het efficiënst, omdat er dan geen vrije ruimte meer overblijft. Eén munt neemt dus 100\% van de oppervlakte van het cirkelvormig dienblad in.
	
	\item \textbf{Driehoekig dienblad:}\\
	Bij een driehoekig dienblad is de lengte van de basis gelijk aan $2.2.\tan(\pi/6)=4\sqrt{3}\approx 6,9282$. De hoogte is $\sqrt{b^2-(\frac{b}{2})^2}= 6$
	De oppervlakte van de gelijkzijdige driehoek is dus $20,7846$ cm$^2$. Hieruit volgt dat 1 munt 60,46 \% van de oppervlakte van het driehoekig dienblad inneemt.
	
	
	\item \textbf{Rechthoekig dienblad:}\\
	De oppervlakte van de meest compacte rechthoek voor 1 jeton is niet moeilijk te vinden. Aangezien we zien dat de lengte en de breedte beide gelijk zijn aan de diamter van de munt, weten we dat de oppervlakte van de rechthoek gelijk is aan $4^2=16$. Hieruit volt dat 1 munt 78,54\% van de oppervlakte van het rechthoekig dienblad inneemt.
	
	
	\item \textbf{Zeshoekig dienblad:}\\
	Voor de oppervlakte van de gelijkzijdige zeshoek te berekenen, moeten we de straal van deze zeshoek berekenen (of zijde, die daaraan gelijk is). Deze is gelijk aan de straal van de jeton gedeeld door $\cos(\pi/6)$. Dus in de formule $\frac{3}{2}.z^2.\sqrt{3}$ is $z=2,3094$ en vinden we dus dat de oppervlakte van de zeshoek gelijk is aan 13,8564 cm. De munt neemt dus 90,69\% van de oppervlakte van het zeshoekig dienblad in.
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
	  \item Oppervlakte dienblad = $16\pi\approx 50,2655$
	  \item Compactheid = 50\%
  \end{itemize}
	...
	De grootte van basis van de driehoek is gelijk aan de grootte van de projectie van het lijnstuk FI (op de figuur) en de afstand IJ. Deze laatste is twee keer de straal van de jetons, dus gelijk aan 4, omdat de cirkels elkaar juist raken. De projectie van FI heeft grootte $2\sqrt{3}$ zoals bij de berekeningen van het voorbeeld met 1 munt. De grootte van de basis is dus gelijk aan 4+4$\sqrt{3}\approx 10,9282$. Met deze basis weten we dat de hoogte van de driehoek 9,4641 is. Hieruit vinden we :
