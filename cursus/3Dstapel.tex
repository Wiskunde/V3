...
\answer{
Het is nu de bedoeling dat de leerlingen zelf de formule gaan zoeken en vinden door dit uit te testen voor verschillende vormen van grondvlakken en voor verschillende lagen ($n = 1, 2, ... , 6 , ... , 100$). Hiervoor kunnen ze dus gebruik maken van knikkers, waarbij je best ook zorgt voor een ruwe ondergrond of een soort omkadering voor het grondvlak. Ook andere bolvormige voorwerpen kunnen gebruikt worden.
...
\begin{itemize}
	\item Kan je van twee vierkante piramides een nieuwe vierkante piramide maken? 
...
\taks{ Reken dit even uit om te zien dat dit inderdaad overeenkomt met de formule die wij reeds vonden.}
...
Het is wel mogelijk om uit twee opeenvolgende driehoekige piramides precies één vierkante piramide te maken. Een driehoekige piramide van 4 lagen hoog en een van 5 hoog bestaan samen bijvoorbeeld uit 20+35=55 kogels, precies genoeg voor een vierkante piramide van 5 lagen hoog.
...
%Uit het Zebraboekje
In 1609 beschreef Kepler voor het eerst de dichtste bolstapeling, in een boekje over sneeuwkristallen. Zoals we al gezien hebben krijg je deze stapeling door eerst in het vlak een dichtste stapeling te maken van één laag: een hexagonaal patroon, waarbij iedere bol raakt aan zes buren. Dan maak je nog zo'n laag en die leg je er iets verschoven op, zó dat de bollen net in de kuiltjes van de laag eronder rusten. Bij elke volgende laag zijn er trouwens twee keuzes te maken die niet equivalent zijn. Als we de positie van de middelpunten van de bollen in de eerste laag met $A$ aangeven en van de tweede met $B$ ...
...
\todo{Dit zou ik weglaten, maar ik ga het bekijken als ik morgen of overmorgen het 3D stuk aanpak!!}

Het bolstapelprobleem zoals hierboven uitgelegd is zeker iets dat vele toepassingen heeft.
Driedimensionale stapelproblemen komen in vele verschillende vormen voor. Als we denken aan containerschepen dan komen we al ogenblikkelijk terecht bij het stapelen van goederen. De bedrijven willen natuurlijk zoveel mogelijk goederen in hun containers krijgen en daarvoor hebben ze wiskundigen nodig die kunnen berekenen welke stapeling de meest compacte is. Ook in de voedingssector komen driedimensionale stapelproblemen frequent voor. Het meest bekende voorbeeld is het stapelen van sinaasappels, maar de fruit- en groentetelers willen natuurlijk ook hun kiwi's, mango's, meloenen, kolen... zo compact mogelijk stapelen. Hierbij stellen we ons de vraag of er voorwerpen zijn (buiten kubussen en balken) die we compacter kunnen stapelen dan bollen. Met andere woorden, we zoeken voorwerpen die we kunnen stapelen en waarbij de dichtheid van de stapeling groter is dan 74.048\%.

Ons vermoeden is dat die voorwerpen misschien wel ellipsoïden kunnen zijn. Ellipsoïden zijn voorwerpen die gevormd worden door een ellips om zijn langste as te wentelen. Wanneer we nu identieke ellipsoïden stapelen hopen we dat de dichtheid groter is dan bij de bolstapeling.

Om dit praktisch uit te voeren, maken we gebruik van ellipsoïden die we in de herfst in de natuur kunnen terugvinden, namelijk eikels (van de zomereik).
Eikels hebben meestal wel niet dezelfde afmetingen.
\ask{Hoe zouden we dit probleem kunnen incalculeren?}
\answer{Voor onze berekeningen zullen we bij elke eikel afzonderlijk de afmetingen met een schuifmaat meten. Deze afmetingen zullen we in lijsten stoppen, waarna we van elke eikel het volume berekenen. Uiteindelijk kijken we hoe groot het totale volume is dat de eikels innemen in het voorwerp waarna we de dichtheid van de stapeling berekenen.} 
Bij ons praktisch probleem zullen we de eikels op verschillende manieren in een balkvormige doos stapelen. Ons doel is om te kijken of we deze ellipsoïden compacter kunnen stapelen dan sinaasappels bij de bolstapeling.
