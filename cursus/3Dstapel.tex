...
\answer{In één dimensie is het 'kissing number' 2, in twee dimensies 6.}
\begin{figure}[h]
  \centering
...
In tussentijd probeerden de wiskundigen wel om het vermoeden van Kepler op een andere manier te bewijzen. Zij deden dit door te kijken welke dichtheid er maximaal bereikt kan worden. Indien het hen zou lukken om deze bovengrens te verlagen tot 74.05\%  kon men Kepler bij verstek gelijk geven, aangezien de dichtheid die hij verkreeg \[\frac{\pi}{\sqrt{18}}\approx 0,74048048\dots\%\] was. Daardoor zou de grens tussen de dichtheid bij de face-centered cubic packing en de bovengrens zo klein zijn dat er geen betere pakking meer kon bestaan dan de face-centered cubic pakking.
...
\vspace{-10mm}
 ...
 \end{center}
 \vspace{-5mm}
  \caption{Thomas Hales}
\end{wrapfigure}
\todo{De figuur is nog raar in dit geheel.}
