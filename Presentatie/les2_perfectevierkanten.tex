\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \input{afbeeldingen/vierkant10_3x3}
    \end{column}
    \begin{column}{0.5\textwidth}
    \begin{itemize}
      \item Voorbeeld:
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      \only<1-3>{\input{afbeeldingen/fig_pv21}}
      \only<4>{\input{afbeeldingen/fig_pv21_fractaal}}
    \end{column}
    ...
    {\scriptsize
      \begin{itemize}
        ...
        \pause
        \item Het vierkant heeft $8$ symmetrieën, de dihedrale groep $D4$, dus één oplossing leidt tot 8 isomorfe oplossingen.
          \begin{center}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      %\only<1>{\input{afbeeldingen/pv_kleinstevierkant}}
      \input{afbeeldingen/pv_kleinstevierkant}
    \end{column}
    \begin{column}{0.5\textwidth}
    {\scriptsize
      \begin{stelling}
      ...
      {\tiny
        \begin{list}{}{\leftmargin=0pt}
          ...
          \pause
          \item Dus Ã©Ã©n van de vierkantjes komt over de rand!
          \pause
