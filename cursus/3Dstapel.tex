...
De hoogte $h$ van de tetraëder is de lengte van z'n hoogtelijn $TP$. Dat is de lijn die je krijgt door de tetraëder op de tafel te zetten en vanuit het hoogste punt een lijn loodrecht naar beneden te trekken. Het onderste punt $P$ ligt precies midden in de onderste gelijkzijdige driehoek, even ver van alledrie de hoekpunten af. De driehoek $\Delta HMP$ heeft hoeken $30°$, $60°$ en $90°$. Aangezien $r= |HM|= |HP|. \cos(30°)=r.\frac{\sqrt{3}}{2}$ vinden we dat $$ |HP|=x= \frac{2}{\sqrt{3}}r.$$
