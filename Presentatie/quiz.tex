...
%\subsection{Vraag 1}
\begin{frame}
\frametitle{Bolstapelprobleem van Kepler: ontstaan}
\framesubtitle{Vraag 1}
...
\begin{frame}
\frametitle{Bolstapelprobleem van Kepler: evolutie}
\framesubtitle{Vraag 4}
...
\begin{frame}
\frametitle{Bolstapelprobleem van Kepler: evolutie}
\framesubtitle{Vraag 5}

\begin{block}
{Welke Scandinavische wiskundige ontwikkelde een theorie over het tweedimensionale equivalent voor \textquoteleft het probleem van Kepler' waarbij men zoekt naar de dichtste pakkingsmethode voor cirkels in het vlak?}
\begin{itemize}
	\item[A] Axel Thue
...
\begin{block}
{Welke Scandinavische wiskundige ontwikkelde een theorie over het tweedimensionale equivalent voor 'het probleem van Kepler' waarbij men zoekt naar de dichtste pakkingsmethode voor cirkels in het vlak?}
...
\begin{frame}
\frametitle{Bolstapelprobleem van Kepler: bewijs}
\framesubtitle{Vraag 7}
