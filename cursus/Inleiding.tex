...
\begin{figure}[h]
  \centering
  \subfloat[]{\includegraphics[height=7cm]{PIC0135}}
  \subfloat[]{\includegraphics[height=7cm]{PIC0137}}\\
\end{figure}\\
...
\begin{figure}
\centering
\includegraphics[height=7cm]{driehoek1}
\end{figure}

\ask{Wat is er hier aan de hand?}

\answer{Bekijk de oppervlaktes van de rode driehoek, de blauwe driehoek en de grote driehoek. Deze laatste is eigenlijk geen driehoek, want als je kijkt naar de verhoudingen van basis en hoogte van de kleine driehoeken, zie je dat er een knik zit in de zogezegde schuine zijde van de grote driehoek.}
