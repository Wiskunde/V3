...
\answer{Rechtoek, vierkant, driehoek, cirkel, \ldots}\\
...
\ask{Als we nu het vlak willen vullen met identieke figuren mogen deze figuren dan overlappen?}\\
\answer{Nee, want anders is dit geen vlakvulling}\\
\teacher{De leerlingen kunnen ook redeneren waarom dit zo is.}\\
...
\ask{Kan je een voorbeeld vinden van een driehoek die gevuld is met driehoeken?}\\
\answer{Een voorbeeld van driehoeken in driehoeken is de driehoek van sierpinski.}\\
\teacher{Er kunnen ook nog enkele puzzels worden uitgedeeld die de leerlingen kunnen oplossen. Dit kan eventueel in groep.}
\begin{figure}[h]
  \centering
