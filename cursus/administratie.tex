...
\end{itemize}
\subsection{Decretale specifieke eindtermen wiskunde}
Bij dit lessenpakket horen de volgende decretale specifieke eindtermen.\\
...
\begin{itemize}
\item verbanden leggen tussen wiskunde en praktische toepassingen uit het dagelijkse leven en zo relaties leggen met problemen uit maatschappij, wetenschap en techniek,
\item een wiskundig denken en redeneren ontwikkelen, d.w.z. een wiskundig eigen wijze van: 
	\begin{itemize}
	\item bevragen, onderzoeken en formuleren van vermoedens,
	\item modelleren en structureren,
	\item argumenteren en bewijzen,
	\end{itemize}
\item gesloten en open problemen wiskundig kunnen stellen en analyseren, en oplossingen argumenteren en bespreken,
\item communiceren over wiskundig beschreven situaties, met inbegrip van het vlotte gebruik van meer specifieke wiskundetaal,
\item kritisch reflecteren op denken en handelen.
\end{itemize}
