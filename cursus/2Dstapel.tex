...
\\\todo{figuren apart plaatsen bij elk voorbeeld}
...
\teacher{De sectie is vooral bedoeld voor de leerlingen om hen te doen inzien dat ze het ook belangrijk is om niet steeds zomaar op de intuïtie in te gaan, maar dat dit ook moet aangetoond worden om zeker te zijn. In ons geval is echter onze intuïtie correct volgens het bewijs. De leerlingen kunnen dit bewijs zelf doorlopen met deze cursus en dit begrijpen via een figuur die ze zelf knutselen.}

Bij de voorbeelden in vorige sectie was het algauw intuïtief duidelijk hoe we de munten moeten plaatsen om zo efficiënt mogelijk het dienblad te vullen. Het is echter soms belangrijk dat je echt ook zeker weet dat er geen configuratie bestaand die het dienblad nog efficiënter vult. 

We zullen ons nu richten op het probleem met 4 munten voor een driehoekig dienblad.

Jullie hebben daarnet met de geogebra-applet of bij het schuiven waarbij je op een bepaald moment niet meer verder met de munten kon verschuiven, maar waarbij je wist dat de configuratie beter.
\ask{Geef drie voorbeelden van configuraties met 4 munten die je niet verder kan verschuiven}

\answer{\todo{Pieter, kan jij er 4 trekken met je jetons?? Ofwel doen we het gewoon met geogebra zoals op onderstaande figuur}
\begin{figure}[h]
...
Beschouw volgende figuur\todo{Maken!!}.

%\begin{figure}[]
%\includegraphics[width=\columnwidth]{bewijs}
...
\ask{Zouden er nog andere configuraties met vier munten zijn, die in dit driehoekig dienblad passen?}{1}
