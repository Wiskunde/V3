...
% gebruik: \answer{Dit is een antwoord}{2}
% eerste parameter is het antwoord, tweede parameter is hoeveel ruimte de leerlingen wordt gegeven in cm
\newcommand{\answer}[2]{{\textcolor{gray}{\emph{#1}}}}
%\newcommand{\answer}[2]{\vspace*{#2cm}}
