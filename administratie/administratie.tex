...
\item De leerlingen kunnen in groep samenwerken om enkele raadsels en puzzels op te lossen.
\end{itemize}
...
\item De leerlingen kunnen in groepjes samenwerken.
...
Het is echter ook de bedoeling om de leerlingen sommige configuraties ook echt te laten tekenen en hun de efficiëntie te laten berekenen.
De leerkracht kan de leerlingen zeggen dat ze dit voor een bepaald aantal moeten doen of voor enkele specifieke gevallen.
Je kan de klas ook opsplitsen, zodanig dat niet iedereen alle efficiënties moet berekenen, maar dat je met de ganse klas wel degelijk komt tot een volledig ingevulde tabel.
...
\item De leerlingen kunnen de efficiëntie van ingewikkelde configuraties berekenen.
\item De leerlingen kunnen vorige berekeningen gebruiken om ingewikkelde configuraties te vereenvoudigen.
\item De leerlingen kunnen uit experimentele resultaten conclusies trekken over de meest efficiënte dienbladen, en kunnen ook (mogelijke) verklaringen geven
...
\subsubsection{Didactische wenken}
Deze les is vooral bedoeld om de leerlingen te doen inzien dat ze niet steeds zomaar op de intuïtie kunnen afgaan. Het uitproberen met Geogebra is leuk, het experimenteren met figuren ook. Je ziet dan snel in `op het gevoel' dat je niet efficiënter kan, maar het is belangrijk om dit ook aan te tonen. We zullen het geval behandelen van een driehoekig dienblad met vier munten. In dit geval is de intuïtie wel degelijk correct want we vinden er een bewijs voor. De leerlingen kunnen dit bewijs zelf doorlopen met deze cursus en dit begrijpen via een figuur die ze zelf knutselen.
...
Belangrijk is om op het einde de volledige tabel, die in de vorige les normaalgezien al was samengelegd, te overlopen en er de belangrijkste zaken uit te halen over wat nu de efficiëntste dienbladen zijn in welke gevallen dit klopt met de intuïtie. Het is goed om hier met de leerlingen bij stil te staan dat het belangrijk is om uit de cijfers ook daadwerkelijk nuttige informatie te halen en om hierover te discussiëren met medeleerlingen voor mogelijk verklaringen van hun bevindingen. Ook leuk om op te merken is dat in de realiteit de dienbladen die in de horeca gebruikt worden net zulke dienbladen zijn waarvan we vinden dat ze het efficiëntst zijn! 
...
Ook krijgen de leerlingen een aantal andere vragen mee die ze in kleine groepjes moeten gaan uitproberen. Uiteraard hoeven de leerlingen niet constant met de knikkers te werken. Eenmaal ze het systeem doorhebben, kunnen ze met de rijen op papier werken en algebraïsch de vragen oplossen.
